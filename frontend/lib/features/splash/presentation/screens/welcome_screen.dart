  ...
  final List<Map<String, dynamic>> _onboardingData = [
    {
      ...
      'title_2': ' Meals',
      'subtitle':
          'Get personalized healthy food recommendations tailored to your needs, preferences, and daily lifestyle.',
    ...
    },
    {
      ...
      'title_2': '',
      'subtitle':
          'Easily compare prices across multiple delivery apps in one place and choose the most affordable option.',
    ...
    },
    {
      ...
      'title_2': '',
      'subtitle':
          'Track your daily healthy eating habits and build a consistent streak to support a better lifestyle over time.',
    ...
    return Scaffold(
      ...
      body: AnimatedBuilder(
        ...
        builder: (context, child) {
          ...
          if (page >= 0 && page < 1) {
            bgColor = Color.lerp(
              _onboardingData[0]['bg_color'],
              _onboardingData[1]['bg_color'],
              page,
            );
          } else if (page >= 1 && page <= 2) {
            bgColor = Color.lerp(
              _onboardingData[1]['bg_color'],
              _onboardingData[2]['bg_color'],
              page - 1,
            );
          }
                    ...
                    children: [
                      RichText(
                        ...
                        text: TextSpan(
                          ...
                          children: [
                            TextSpan(
                              text: _onboardingData[_currentPage]['title_1'],
                            ),
                            TextSpan(
                              text:
                                  _onboardingData[_currentPage]['title_green'],
                              style: AppTextStyles.heading2.copyWith(
                                color: AppColors.primary,
                              ),
                            ),
                            TextSpan(
                              text: _onboardingData[_currentPage]['title_2'],
                            ),
                          ],
                        ),
                      ),
